...
public class QuenMatKhauJDialog extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jLabel3.setText("Nhập mã xác minh:");
        ...
        btnGuima.setFont(new java.awt.Font("Tahoma", 0, 18)); // NOI18N
        ...
        btnXacminh.setBackground(new java.awt.Color(0, 153, 255));
        btnXacminh.setFont(new java.awt.Font("Tahoma", 1, 18)); // NOI18N
        btnXacminh.setForeground(new java.awt.Color(255, 255, 255));
        btnXacminh.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Images/icon_verify1x.png"))); // NOI18N
        btnXacminh.setText("Xác minh");
        btnXacminh.setBorder(null);
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addComponent(txtMaXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtmkMoi, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(txtXacnhanMK, javax.swing.GroupLayout.PREFERRED_SIZE, 303, javax.swing.GroupLayout.PREFERRED_SIZE))
                                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, 80, Short.MAX_VALUE)
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    .addComponent(btnGuima, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
                                    .addComponent(btnXacminh, javax.swing.GroupLayout.PREFERRED_SIZE, 124, javax.swing.GroupLayout.PREFERRED_SIZE)))))
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(408, 408, 408)
                        .addComponent(btnXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 113, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(69, 69, 69)
                        .addComponent(btnGuima, javax.swing.GroupLayout.PREFERRED_SIZE, 41, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGap(28, 28, 28)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                            .addComponent(jLabel3)
                            .addComponent(txtMaXacNhan, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE)))
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel1Layout.createSequentialGroup()
                        .addGap(26, 26, 26)
                        .addComponent(btnXacminh, javax.swing.GroupLayout.PREFERRED_SIZE, 44, javax.swing.GroupLayout.PREFERRED_SIZE)))
                .addGap(23, 23, 23)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jLabel4)
                    .addComponent(txtmkMoi, javax.swing.GroupLayout.PREFERRED_SIZE, 42, javax.swing.GroupLayout.PREFERRED_SIZE))
                .addGap(30, 30, 30)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(jLabel5)
...
//        nhanvien = nvDao.selectByEmail(email);
//        System.out.println(email);
//        if(nhanvien != null){
//            Random rd = new Random();
//            verifycode = String.format("%06d", rd.nextInt(999999));
//            try {
//                EmailHelper.sendVerifyCode(nhanvien.getEmail(), verifycode);
//            } catch (Exception e) {
...
//        btnXacminh.setEnabled(false);
        nhanvien = nvDao.selectByEmail(txtEmail.getText());
        try {
            ...
            String username = "chungntph13390@fpt.edu.vn";
            String password = "Chung0809";
            ...
            msg.setText("Mã xác nhận của bạn là :" + verifycode);
            Transport.send(msg);
    ...
    private void btnXacNhanActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacNhanActionPerformed
        ...
        String confimPass = txtXacnhanMK.getText();
        if (newPass.equals(confimPass)) {
            nhanvien.setMaNv(newPass);
            nvDao.update_pass(nhanvien);
    ...
    private void btnXacminhActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnXacminhActionPerformed
        if (verifycode.equals(txtMaXacNhan.getText())) {
            txtMaXacNhan.setEnabled(false);
            btnXacminh.setEnabled(false);
            txtmkMoi.setEditable(true);

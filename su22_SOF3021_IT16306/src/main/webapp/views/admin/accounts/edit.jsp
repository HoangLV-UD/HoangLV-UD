...
<head>
<meta charset="UTF-8">
<title>IT16306 - Update Account</title>
<link rel="stylesheet"
...
<div class="row m-2">
		<a href="http://localhost:8080/su22_SOF3021_IT16306/admin/accounts/index" 
			class=" btn btn-primary"> Danh Sách </a>
	</div>
	<form:form method="POST"
		action="/su22_SOF3021_IT16306/admin/accounts/update/${acc.id }"
		modelAttribute="acc">
			...
			<div class=" py-5 h-100">
						...
						<div class="card shadow-2-strong" style="border-radius: 1rem;">
							<div class="card-body p-5 text-center">
								<div>
									...
									<form:input path="fullname" class="form-control form-control" />
				...
				style="color: red;"></form:errors>
								...
								<div>
									...
									<form:input path="username" class="form-control form-control" />
				...
				style="color: red;"></form:errors>
								...
								<div>
									...
									<form:select path="admin" class="form-control form-control">
